...
MESH="lidDrivenCavityFlowZeroedOut.msh"   # .msh mesh file
...
for Re in "${RES[@]}"; do
  ...
  sed -e "s|MESH_FILE|${MESH}|g" \
      ...
      journal_template_aspect_ratios.jou > "1by2aspect_ratio_run_${Re}.jou"
  ...
  echo "  Journal file:     1by2aspect_ratio_run_${Re}.jou"
  ...
  fluent 2d -g -t1 -i "1by2aspect_ratio_run_${Re}.jou" | tee "results/Re${Re}/console.log"
